...
public class KafkaConsumerConfig {
    ...
    // This bean is for Spring Kafka Listeners. Spark Streaming will use its own consumer setup.
    // However, having this can be useful if you decide to add a Spring Kafka listener for other purposes.
    @Bean
    ...
    // We will also need a Map<String, Object> of consumer properties for Spark
    @Bean(name = "sparkKafkaConsumerProperties")
    public Map<String, Object> sparkKafkaConsumerProperties() {
