...
- Candidates are encouraged to use any resource at their disposal (online, documentation, etc.), but **please do not use LLMs (e.g., ChatGPT, Copilot) to generate code or core logic**. The focus is on individual problem-solving approaches.
